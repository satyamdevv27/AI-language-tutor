    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-100 via-gray-100 to-white dark:from-zinc-950 dark:via-zinc-900 dark:to-black text-gray-900 dark:text-white flex flex-col">
      ...
      <header className="border-b border-black/10 dark:border-white/10 backdrop-blur-xl bg-white/60 dark:bg-black/40">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {/* Logo */}
          <div className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">
            AI Buddy
          </div>
      ...
      <main className={`flex-1 max-w-7xl mx-auto px-6 py-16 w-full ${!isLoggedIn ? "flex flex-col justify-center" : ""}`}>
        ...
        <div className="text-center mb-20 relative">
          ...
          <div className="absolute inset-0 -z-10 blur-3xl opacity-20 
                          ...
                          rounded-full w-[600px] h-[300px] mx-auto top-[-40px]" />

          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight pb-2 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-2xl bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl border border-black/5 dark:border-white/5 p-6 hover:-translate-y-2 transition-all duration-500 hover:border-indigo-500/40 hover:shadow-[0_20px_50px_-10px_rgba(99,102,241,0.35)]"
          >
            ...
            <p className="text-gray-600 dark:text-zinc-400 text-sm">
              Have natural conversations with your AI tutor.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-zinc-400 text-sm">
              Sharpen thinking with AI-powered debates.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-zinc-400 text-sm">
              Practice real-life English situations.
            </p>
          </Link>
